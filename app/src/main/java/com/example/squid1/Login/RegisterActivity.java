...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.tvLoginLink).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(RegisterActivity.this, com.example.squid1.Login.LoginActivity.class));
            }
        });
    }
    ...
    private void registerUser() {
        ...
        Call<ResponseBody> call = RetrofitClient
                .getInstance()
                .getAPI()
                .createUser(new com.example.squid1.Login.User(userName, password));
